  ...
  return api
    ...
    .then(
      ...
      (err) => {
        ...
        return (
          <h1>{`${err.body.error.status} Error: ${err.body.error.message}`}</h1>
        );
      }
    )
    .then((data) => {
      ...
      const content = (
        <div className="object-info">
          ...
          <div className="secondary-object-info">
            ...
            <InfoCard
              type="artist"
              id={topArtists.short.id}
              isTopArtist={true}
              timeFrame={'short'}
            ></InfoCard>
            <InfoCard
              type="track"
              id={topTracks.short.id}
              isTopTrack={true}
              timeFrame={'short'}
            ></InfoCard>
            <InfoCard
              type="artist"
              id={topArtists.long.id}
              isTopArtist={true}
              timeFrame={'long'}
            ></InfoCard>
            <InfoCard
              type="track"
              id={topTracks.long.id}
              isTopTrack={true}
              timeFrame={'long'}
            ></InfoCard>
          </div>
          <div className="additional-object-info">
            <div className="public-playlists">
              <h1 align="left" style={{ marginBottom: '20px', width: '80%' }}>
                Your Public Playlists <a href="#">SEE ALL</a>
              </h1>
            ...
            <div className="private-playlists">
              <h1 align="left" style={{ marginBottom: '20px ', width: '80%' }}>
                Your Private Playlists <a href="#">SEE ALL</a>
              </h1>
              {data.items.map((playlist) => {
